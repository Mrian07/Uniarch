(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab5-tab5-module"], {
    ...
    function srcAppTab5Tab5PageScss(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "ion-badge {\n  position: absolute;\n  background: #f70b0b;\n  border-radius: 50%;\n  opacity: 0.9;\n  top: -9px;\n  right: 17px;\n  width: 20px;\n  height: 20px;\n  font-size: 10px;\n  z-index: 9;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function srcAppTab5Tab5PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var Tab5Page = /*#__PURE__*/function () {
        function Tab5Page(http, modalCtrl, router, navCtrl, servcart, loadingctrl, alertctrl, product_service, route, consta, userdata, util) {
        ...
        _createClass(Tab5Page, [{
          ...
          value: function get_product_detail() {
            ...
            this.http.post(_providers_constant_service__WEBPACK_IMPORTED_MODULE_2__["API_URL_SLIDER"] + 'api_kontak', {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
              ...
              _this3.kontak.wa = hasil.kontak[2].isi_kontak;
              console.log(_this3.kontak.email);
            });
          }
        }, {
          key: "kosong",
