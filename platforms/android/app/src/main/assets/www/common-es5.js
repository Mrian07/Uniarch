        ...
        _createClass(DataCartService, [{
          ...
          value: function getRiwayat(kode_pel) {
            ...
            var promise = new Promise(function (resolve, reject) {
              ...
              _this14.http.post(_providers_constant_service__WEBPACK_IMPORTED_MODULE_3__["API_URL"] + 'get_riwayat_reward', formData).subscribe(function (hasil) {
                console.log('hadiah', 'hasil');
                resolve(hasil);
              });
            });
          ...
          value: function getPoin(kode_pel) {
            ...
            var promise = new Promise(function (resolve, reject) {
              ...
              _this15.http.post(_providers_constant_service__WEBPACK_IMPORTED_MODULE_3__["API_URL"] + 'get_poin', formData).subscribe(function (hasil) {
                console.log('hadiah', 'hasil');
                resolve(hasil);
              });
            });
